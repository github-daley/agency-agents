...
- **[Codex](https://developers.openai.com/codex/skills)** — `SKILL.md` per agent → `~/.codex/skills/`
...
Each agent becomes a Codex skill in `~/.codex/skills/<slug>/SKILL.md`.
On a fresh clone, generate the Codex skill files before running the installer.
...
Restart Codex after installation so it picks up the new skills.

Then reference a skill naturally in Codex:
```
